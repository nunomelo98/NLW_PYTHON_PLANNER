...
# importando fgerente de conexoes
...
@trips_reoutes_bp.route('/trips/<tripId>', methods =['GET'])
...
@trips_reoutes_bp.route('/trips/<tripId>/confirm', methods =['GET'])
...
@trips_reoutes_bp.route('/trips/<tripId>/links', methods =['POST'])
...
@trips_reoutes_bp.route('/trips/<tripId>/links', methods =['GET'])
...
@trips_reoutes_bp.route('/trips/<tripId>/invites', methods =['POST'])
...
@trips_reoutes_bp.route('/trips/<tripId>/activities', methods =['POST'])
...
@trips_reoutes_bp.route('/trips/<tripId>/participants', methods =['GET'])
...
@trips_reoutes_bp.route('/trips/<tripId>/activities', methods =['GET'])
...
@trips_reoutes_bp.route('/participants/<participantId>/confirm', methods =['PATCH'])
